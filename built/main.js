...
class PowerBuilding extends BuildingBase {
    ...
    costString(amt = 1) { return '<small><br /><br />Creates ' + prettify(this.powerPer(amt)) + ' power</small>' + super.costString(amt); }
    updateBuyButtonText() {
...
class ResourceBuilding extends BuildingBase {
    ...
    costString(amt = 1) { return '<small><br /><br />Creates ' + prettify(this.productionPerSecond() * amt / this.buildinginfo.count) + '/s</small>' + super.costString(amt); }
    updateBuyButtonText() {
        this.buyButton.innerHTML = super.buyButtonBaseText() + this.costString();
        this.buy10Button.innerHTML = '10';
    }
...
class PowerConverterBuilding extends BuildingBase {
    ...
    costString(amt = 1) { return ('<small><br /><br />' + prettify(this.getBonus(amt) * 100) + '% efficiency</small>') + super.costString(amt); }
    updateBuyButtonText() {
        this.buyButton.innerHTML = super.buyButtonBaseText() + this.costString();
        this.buy10Button.innerHTML = '10';
    }
...
class TacticBuilding extends BuildingBase {
    ...
    costString(amt = 1) { return ('<small><br /><br />Buying will set value to ' + prettify(this.getBonus(amt) * 100) + '% efficiency</small>') + super.costString(amt); }
    updateBuyButtonText() {
        this.buyButton.innerHTML = super.buyButtonBaseText() + this.costString();
        this.buy10Button.innerHTML = '10';
    }
