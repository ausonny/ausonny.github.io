...
var gameBuildings = {
    panel: {
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                this.updateBuyButtonText();
                this.updateBuyButtonTooltip();
                if (gameData.buildings.panels >= 5)
                    addAchievement(34);
                if (gameData.buildings.panels >= 10)
                    addAchievement(35);
                if (gameData.buildings.panels >= 25)
                    addAchievement(36);
                if (gameData.buildings.panels >= 50)
                    addAchievement(37);
                if (gameData.buildings.panels >= 100)
                    addAchievement(38);
                if (gameData.buildings.panels >= 1000)
                    addAchievement(39);
    ...
    generator: {
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                this.updateBuyButtonText();
                this.updateBuyButtonTooltip();
                if (gameData.buildings.generators >= 1)
                    addAchievement(47);
                if (gameData.buildings.generators >= 5)
                    addAchievement(48);
                if (gameData.buildings.generators >= 10)
                    addAchievement(49);
                if (gameData.buildings.generators >= 25)
                    addAchievement(50);
                if (gameData.buildings.generators >= 50)
                    addAchievement(51);
                if (gameData.buildings.generators >= 100)
                    addAchievement(52);
                if (gameData.buildings.generators >= 1000)
                    addAchievement(53);
    ...
    plant: {
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                this.updateBuyButtonText();
                this.updateBuyButtonTooltip();
                if (gameData.buildings.plants >= 1)
                    addAchievement(40);
                if (gameData.buildings.plants >= 5)
                    addAchievement(41);
                if (gameData.buildings.plants >= 10)
                    addAchievement(42);
                if (gameData.buildings.plants >= 25)
                    addAchievement(43);
                if (gameData.buildings.plants >= 50)
                    addAchievement(44);
                if (gameData.buildings.plants >= 100)
                    addAchievement(45);
                if (gameData.buildings.plants >= 1000)
                    addAchievement(46);
    ...
    aetherPlant: {
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                this.updateBuyButtonText();
                this.updateBuyButtonTooltip();
                if (gameData.buildings.aetherPlants >= 1)
                    addAchievement(54);
                if (gameData.buildings.aetherPlants >= 5)
                    addAchievement(55);
                if (gameData.buildings.aetherPlants >= 10)
                    addAchievement(56);
                if (gameData.buildings.aetherPlants >= 25)
                    addAchievement(57);
                if (gameData.buildings.aetherPlants >= 50)
                    addAchievement(58);
                if (gameData.buildings.aetherPlants >= 100)
                    addAchievement(59);
                if (gameData.buildings.aetherPlants >= 1000)
                    addAchievement(60);
    ...
    fusionPlant: {
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                this.updateBuyButtonText();
                this.updateBuyButtonTooltip();
                if (gameData.buildings.fusionPlants >= 1)
                    addAchievement(74);
                if (gameData.buildings.fusionPlants >= 5)
                    addAchievement(75);
                if (gameData.buildings.fusionPlants >= 10)
                    addAchievement(76);
                if (gameData.buildings.fusionPlants >= 25)
                    addAchievement(77);
                if (gameData.buildings.fusionPlants >= 50)
                    addAchievement(78);
                if (gameData.buildings.fusionPlants >= 100)
                    addAchievement(79);
                if (gameData.buildings.fusionPlants >= 1000)
                    addAchievement(80);
                gtag('event', 'buy aether plant', {
                    event_category: 'click',
                    event_label: 'label',
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                if (gameData.buildings.mines >= 10)
                    addAchievement(1);
                if (gameData.buildings.mines >= 25)
                    addAchievement(2);
                if (gameData.buildings.mines >= 50)
                    addAchievement(3);
                if (gameData.buildings.mines >= 100)
                    addAchievement(4);
                if (gameData.buildings.mines >= 1000)
                    addAchievement(5);
            }
        }
    },
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                if (gameData.buildings.labs >= 1)
                    addAchievement(20);
                if (gameData.buildings.labs >= 5)
                    addAchievement(21);
                if (gameData.buildings.labs >= 10)
                    addAchievement(22);
                if (gameData.buildings.labs >= 25)
                    addAchievement(23);
                if (gameData.buildings.labs >= 50)
                    addAchievement(24);
                if (gameData.buildings.labs >= 100)
                    addAchievement(25);
                if (gameData.buildings.labs >= 1000)
                    addAchievement(26);
                gtag('event', 'buy lab', {
                    event_category: 'click',
                    event_label: 'label',
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                if (gameData.buildings.factories >= 10)
                    addAchievement(8);
                if (gameData.buildings.factories >= 25)
                    addAchievement(9);
                if (gameData.buildings.factories >= 50)
                    addAchievement(10);
                if (gameData.buildings.factories >= 100)
                    addAchievement(11);
                if (gameData.buildings.factories >= 1000)
                    addAchievement(12);
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                if (gameData.buildings.refineries >= 1)
                    addAchievement(13);
                if (gameData.buildings.refineries >= 5)
                    addAchievement(14);
                if (gameData.buildings.refineries >= 10)
                    addAchievement(15);
                if (gameData.buildings.refineries >= 25)
                    addAchievement(16);
                if (gameData.buildings.refineries >= 50)
                    addAchievement(17);
                if (gameData.buildings.refineries >= 100)
                    addAchievement(18);
                if (gameData.buildings.refineries >= 1000)
                    addAchievement(19);
    ...
    tacticalLab: {
        ...
        aetherForBuy: function () { return (TACTICAL_LAB_AETHER_BASE_COST * Math.pow(TACTICAL_LAB_GROWTH_FACTOR, gameData.buildings.tacticalLabs)); },
        ...
        canAffordBuy: function () { return (gameData.resources.metal >= this.metalForBuy() && gameData.resources.polymer >= this.polymerForBuy() && gameData.resources.aether >= this.aetherForBuy() && CheckPower(this.powerForBuy())); },
        ...
        buy: function () {
            if (this.canAffordBuy()) {
                ...
                this.updateBuyButtonText();
                this.updateBuyButtonTooltip();
                if (gameData.buildings.tacticalLabs >= 1)
                    addAchievement(27);
                if (gameData.buildings.tacticalLabs >= 5)
                    addAchievement(28);
                if (gameData.buildings.tacticalLabs >= 10)
                    addAchievement(29);
                if (gameData.buildings.tacticalLabs >= 25)
                    addAchievement(30);
                if (gameData.buildings.tacticalLabs >= 50)
                    addAchievement(31);
                if (gameData.buildings.tacticalLabs >= 100)
                    addAchievement(32);
                if (gameData.buildings.tacticalLabs >= 1000)
                    addAchievement(33);
...
var gameEquipment = {
    railgun: {
        ...
        updatePrestigeText: function () { $('#btnRailgunPrestige').text('I'); },
    ...
    laser: {
        ...
        updatePrestigeText: function () { $('#btnLaserPrestige').text('I'); },
    ...
    missile: {
        ...
        updatePrestigeText: function () { $('#btnMissilePrestige').text('I'); },
    ...
    armor: {
        ...
        updatePrestigeText: function () { $('#btnArmorPrestige').text('I'); },
    ...
    shield: {
        ...
        updatePrestigeText: function () { $('#btnShieldPrestige').text('I'); },
    ...
    flak: {
        ...
        updatePrestigeText: function () { $('#btnFlakPrestige').text('I'); },
...
function init(passedperks, passedchallenges, gatewayReset = false, activeChallenge = '', chronoton = 0, passedAchievements = []) {
    ...
    if (gatewayReset) {
        ...
        if (savegame !== null) {
            ...
            if (typeof savegame.technologies.metalProficiencyUnlocked !== 'undefined')
                gameData.technologies.metalProficiencyUnlocked = savegame.technologies.metalProficiencyUnlocked;
            if (typeof savegame.technologies.metalProficiencyBought !== 'undefined')
                gameData.technologies.metalProficiencyBought = savegame.technologies.metalProficiencyBought;
            if (typeof savegame.technologies.polymerProficiencyUnlocked !== 'undefined')
                gameData.technologies.polymerProficiencyUnlocked = savegame.technologies.polymerProficiencyUnlocked;
            if (typeof savegame.technologies.polymerProficiencyBought !== 'undefined')
                gameData.technologies.polymerProficiencyBought = savegame.technologies.polymerProficiencyBought;
            ...
            if (typeof savegame.technologies.researchProficiencyBought !== 'undefined')
                gameData.technologies.researchProficiencyBought = savegame.technologies.researchProficiencyBought;
            if (typeof savegame.technologies.aetherProficiencyUnlocked !== 'undefined')
                gameData.technologies.aetherProficiencyUnlocked = savegame.technologies.aetherProficiencyUnlocked;
            if (typeof savegame.technologies.aetherProficiencyBought !== 'undefined')
                gameData.technologies.aetherProficiencyBought = savegame.technologies.aetherProficiencyBought;
            ...
            if (typeof savegame.technologies.railgunPrestigeLevelUnlocked !== 'undefined')
                gameData.technologies.railgunPrestigeLevelUnlocked = savegame.technologies.railgunPrestigeLevelUnlocked;
            if (typeof savegame.technologies.railgunPrestigeLevelBought !== 'undefined')
                gameData.technologies.railgunPrestigeLevelBought = savegame.technologies.railgunPrestigeLevelBought;
            if (typeof savegame.technologies.railgunUpgrade !== 'undefined')
                gameData.technologies.railgunUpgrade = savegame.technologies.railgunUpgrade;
            if (typeof savegame.technologies.laserPrestigeLevelUnlocked !== 'undefined')
                gameData.technologies.laserPrestigeLevelUnlocked = savegame.technologies.laserPrestigeLevelUnlocked;
            if (typeof savegame.technologies.laserPrestigeLevelBought !== 'undefined')
                gameData.technologies.laserPrestigeLevelBought = savegame.technologies.laserPrestigeLevelBought;
            if (typeof savegame.technologies.laserUpgrade !== 'undefined')
                gameData.technologies.laserUpgrade = savegame.technologies.laserUpgrade;
            if (typeof savegame.technologies.missilePrestigeLevelUnlocked !== 'undefined')
                gameData.technologies.missilePrestigeLevelUnlocked = savegame.technologies.missilePrestigeLevelUnlocked;
            if (typeof savegame.technologies.missilePrestigeLevelBought !== 'undefined')
                gameData.technologies.missilePrestigeLevelBought = savegame.technologies.missilePrestigeLevelBought;
            if (typeof savegame.technologies.missileUpgrade !== 'undefined')
                gameData.technologies.missileUpgrade = savegame.technologies.missileUpgrade;
            if (typeof savegame.technologies.armorPrestigeLevelUnlocked !== 'undefined')
                gameData.technologies.armorPrestigeLevelUnlocked = savegame.technologies.armorPrestigeLevelUnlocked;
            if (typeof savegame.technologies.armorPrestigeLevelBought !== 'undefined')
                gameData.technologies.armorPrestigeLevelBought = savegame.technologies.armorPrestigeLevelBought;
            if (typeof savegame.technologies.armorUpgrade !== 'undefined')
                gameData.technologies.armorUpgrade = savegame.technologies.armorUpgrade;
            if (typeof savegame.technologies.shieldPrestigeLevelUnlocked !== 'undefined')
                gameData.technologies.shieldPrestigeLevelUnlocked = savegame.technologies.shieldPrestigeLevelUnlocked;
            if (typeof savegame.technologies.shieldPrestigeLevelBought !== 'undefined')
                gameData.technologies.shieldPrestigeLevelBought = savegame.technologies.shieldPrestigeLevelBought;
            if (typeof savegame.technologies.shieldUpgrade !== 'undefined')
                gameData.technologies.shieldUpgrade = savegame.technologies.shieldUpgrade;
            if (typeof savegame.technologies.flakPrestigeLevelUnlocked !== 'undefined')
                gameData.technologies.flakPrestigeLevelUnlocked = savegame.technologies.flakPrestigeLevelUnlocked;
            if (typeof savegame.technologies.flakPrestigeLevelBought !== 'undefined')
                gameData.technologies.flakPrestigeLevelBought = savegame.technologies.flakPrestigeLevelBought;
            if (typeof savegame.technologies.flakUpgrade !== 'undefined')
                gameData.technologies.flakUpgrade = savegame.technologies.flakUpgrade;
...
function checkForUnlocks() {
    ...
    if (gameData.missions[0].zone === 99) {
        ...
        if (gameData.missions[0].level >= 2) {
            addAchievement(69);
        }
        if (gameData.missions[0].level >= 5) {
            addAchievement(70);
        ...
        if (gameData.missions[0].level >= 20) {
            addAchievement(72);
        }
        if (gameData.missions[0].level >= 40) {
            addAchievement(73);
        }
    }
    if (gameData.missions[0].level > 3) {
    ...
    if (lvlsCleared === 2599) {
        gameData.missions.push(new Mission('The Gateway', true, 2, 1, 25, 100, false));
        updateMissionButtons();
    ...
    if ((gameData.technologies.metalProficiencyUnlocked < Math.floor((lvlsCleared - 9) / 100))) {
        gameData.technologies.metalProficiencyUnlocked = gameData.missions[0].level;
    ...
    if ((gameData.technologies.polymerProficiencyUnlocked < Math.floor((lvlsCleared - 19) / 100))) {
        gameData.technologies.polymerProficiencyUnlocked = gameData.missions[0].level;
    ...
    if (gameData.missions[0].level > 25 && gameData.missions[0].zone === 99) {
        giveChronotonFragments((gameData.missions[0].level - 16) * Math.pow(1.01, (gameData.missions[0].level - 25)));
    }
    if (gameData.missions[0].level > gameData.challenges.consistency.galaxyUnlocked) {
    ...
    if (gameData.missions[0].level > gameData.challenges.consistency.galaxyCompleted && gameData.world.currentChallenge === 'Consistency') {
        gameData.world.currentChallenge = '';
        gameData.challenges.consistency.completed = true;
        $('#btnConfirmConsistency').addClass('hidden');
    }
    if (gameData.missions[0].level > gameData.challenges.power.galaxyUnlocked) {
    ...
    if (gameData.missions[0].level > gameData.challenges.power.galaxyCompleted && gameData.world.currentChallenge === 'Power') {
        gameData.world.currentChallenge = '';
        gameData.challenges.power.completed = true;
        $('#btnConfirmPower').addClass('hidden');
    }
    if (gameData.missions[0].level > gameData.challenges.criticality.galaxyUnlocked) {
    ...
    if (gameData.missions[0].level > gameData.challenges.criticality.galaxyCompleted && gameData.world.currentChallenge.toUpperCase() === 'CRITICALITY') {
        gameData.world.currentChallenge = '';
