...
class Mission {
    constructor(name, missiontype, missionversion, unique, difficulty, lootMultiplier, level, zones, IsGalaxy) {
        this.name = name;
        this.zone = 0;
...
class Ship {
    ...
    createEnemy(size, galaxy, zone, lootType, lootAmount, attackMod, hpMod, shmod, difficulty, ImABoss = false) {
