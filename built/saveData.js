...
class saveGameData {
    constructor(name) {
        ...
        this.storyElements.push(new story('You have collected your first dust. You can upgrade your metal producers and towers with dust. You will also want to collect 10 dust in order to be able to prestige.  Prstiging restarts the game, but with a new resource, pebbles, which you can spend on new upgrades.'));
    }
}
