...
class SaveGameData {
    constructor(name) {
        ...
        this.upgrades = [];
        this.upgrades.push(new Upgrade('Upgrade0', 'Miners x10 productivity<br />', 1, 1.4, this.resources.pebbles, document.getElementById('btnBuyUpgrade0'), 10, 2));
        this.upgrades.push(new Upgrade('Upgrade1', 'Supervisors x10 productivity<br />', 2, 1.5, this.resources.pebbles, document.getElementById('btnBuyUpgrade1'), 10, 2));
        this.upgrades.push(new Upgrade('Upgrade2', 'Foremen x10 productivity<br />', 4, 1.6, this.resources.pebbles, document.getElementById('btnBuyUpgrade2'), 10, 2));
        ...
        this.upgrades.push(new Upgrade('Upgrade6', 'Loot + 10% additive<br />', 1, 1.5, this.resources.pebbles, document.getElementById('btnBuyUpgrade6'), 10, 2));
        this.upgrades.push(new Upgrade('Upgrade7', 'Managers x10 productivity<br />', 10, 1.5, this.resources.pebbles, document.getElementById('btnBuyUpgrade7'), 10, 2));
        this.upgrades.push(new Upgrade('Upgrade8', 'Middle Managers x10 productivity<br />', 100, 1.5, this.resources.pebbles, document.getElementById('btnBuyUpgrade8'), 10, 2));
        this.upgrades.push(new Upgrade('Upgrade9', 'Upper Managers x10 productivity<br />', 1000, 1.5, this.resources.pebbles, document.getElementById('btnBuyUpgrade9'), 10, 2));
        this.upgrades.push(new Upgrade('Upgrade10', 'Vice Presidents x10 productivity<br />', 10000, 1.5, this.resources.pebbles, document.getElementById('btnBuyUpgrade10'), 10, 2));
        this.upgrades.push(new Upgrade('Upgrade11', 'Presidents x10 productivity<br />', 100000, 1.5, this.resources.pebbles, document.getElementById('btnBuyUpgrade11'), 10, 2));
        this.upgrades.push(new Upgrade('Upgrade12', 'Unlock new Metal Producer<br />', 10, 10, this.resources.pebbles, document.getElementById('btnBuyUpgrade12'), 5, 1));
        this.upgrades.push(new Upgrade('Upgrade13', 'Bonus to production from current run time<br />', 1, 1, this.resources.pebbles, document.getElementById('btnBuyUpgrade13'), 1, 5));
        this.upgrades.push(new Upgrade('Upgrade14', 'Bonus from unspent pebbles<br />', 5, 1, this.resources.pebbles, document.getElementById('btnBuyUpgrade14'), 1, 3));
        this.upgrades.push(new Upgrade('Upgrade15', 'Bonus from prestiging<br />', 1, 1, this.resources.pebbles, document.getElementById('btnBuyUpgrade15'), 1, 1));
        this.upgrades.push(new Upgrade('Upgrade16', 'Double bonus from Production Challenges<br />', 100, 1, this.resources.pebbles, document.getElementById('btnBuyUpgrade16'), 1, 1));
        ...
        this.Achievements.push(new Achievement(71, '1Prestige10', 'Prestige 1 time', 1, 1));
        this.Achievements.push(new Achievement(72, '1Prestige50', 'Prestige 10 times', 1, 10));
        this.Achievements.push(new Achievement(73, '1Prestige100', 'Prestige 50 times', 1, 50));
        this.Achievements.push(new Achievement(74, '1Prestige500', 'Prestige 100 times', 1, 100));
        this.Achievements.push(new Achievement(75, '1Prestige1000', 'Prestige 500 times', 1, 500));
        this.Achievements.push(new Achievement(76, '2Prestige10', 'Ascend 1 time', 1, 1));
        this.Achievements.push(new Achievement(77, '2Prestige50', 'Ascend 10 times', 1, 10));
        this.Achievements.push(new Achievement(78, '2Prestige100', 'Ascend 50 times', 1, 50));
        this.Achievements.push(new Achievement(79, '2Prestige500', 'Ascend 100 times', 1, 100));
        this.Achievements.push(new Achievement(80, '2Prestige1000', 'Ascend 500 times', 1, 500));
        ...
        this.Achievements.push(new Achievement(86, '3Prestige10', 'Transform 1 time', 1, 1));
        this.Achievements.push(new Achievement(87, '3Prestige50', 'Transform 10 times', 1, 10));
        this.Achievements.push(new Achievement(88, '3Prestige100', 'Transform 50 times', 1, 50));
        this.Achievements.push(new Achievement(89, '3Prestige500', 'Transform 100 times', 1, 100));
        this.Achievements.push(new Achievement(90, '3Prestige1000', 'Transform 500 times', 1, 500));
        this.tier1Feats = [];
