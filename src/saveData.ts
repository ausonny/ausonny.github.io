...
class SaveGameData {
  ...
  world: {
      ...
      oliphantEnemiesToSpawn: number;
      blitzEnemiesToSpawn: number,
      falconEnemiesToSpawn: number,
      titanEnemiesToSpawn: number,
      bossEnemiesToSpawn: number;
      archerEnemiesToSpawn: number;
      deathlevel: number;
    };
  ...
  constructor (name: string) {
    ...
    this.tier1Feats.push(
      new Achievement(2, 'TierNoManagers1', 'Complete Tier 1 with no Managers', 1, 1)
    );
    this.tier1Feats.push(
    ...
    this.tier2Feats.push(
      new Achievement(1, 'CompleteTier2', 'Complete Tier 2', 1, 2)
    );
    this.tier2Feats.push(
      new Achievement(2, 'TierNoManagers2', 'Complete Tier 2 with no Managers', 1, 2)
    );
    this.tier2Feats.push(
      new Achievement(3, 'TierChallenge2', 'Complete Tier 2 with a challenge active', 1, 2)
    );
