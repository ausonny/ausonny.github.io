...
class SaveGameData {
  ...
  resources: {
    ...
    food: Resource;
    arrow: Resource;
    redResearch: Resource;
  };

  powderUpgrades: Upgrade[];

  pebbleUpgrades: Upgrade[];
  ...
  tierBlueprints: TierBluePrint[];

  tierblueprintsauto: boolean;
  ...
  constructor(name: string) {
    ...
    this.Achievements.push(
      new Achievements(
        ...
        'Building',
        'Buy building levels',
        [new JBDecimal(1), new JBDecimal(5), new JBDecimal(10), new JBDecimal(50), new JBDecimal(100), new JBDecimal(500), new JBDecimal(1000), new JBDecimal(5000), new JBDecimal(10000), new JBDecimal(50000)],
        0
      )
    );
    ...
    this.Achievements.push(
      new Achievements(
        ...
        'Challenge',
        'Complete challenges',
        [new JBDecimal(1), new JBDecimal(2), new JBDecimal(4), new JBDecimal(8), new JBDecimal(16), new JBDecimal(25), new JBDecimal(50), new JBDecimal(100), new JBDecimal(200), new JBDecimal(400)],
        0
      )
    );
    ...
    this.Achievements.push(
      new Achievements(
        11,
        'Survivor',
        'Wave reached without failing',
        [new JBDecimal(5), new JBDecimal(10), new JBDecimal(20), new JBDecimal(30), new JBDecimal(40), new JBDecimal(50), new JBDecimal(60), new JBDecimal(70), new JBDecimal(80), new JBDecimal(90), new JBDecimal(100)],
        0
      )
    );
    ...
    this.Achievements.push(
      new Achievements(
        11,
        'Population',
        'Reach population level',
        [new JBDecimal(25), new JBDecimal(50), new JBDecimal(100), new JBDecimal(200), new JBDecimal(500), new JBDecimal(1000), new JBDecimal(2000), new JBDecimal(5000), new JBDecimal(10000), new JBDecimal(20000), new JBDecimal(50000)],
        0
      )
    );
    ...
    this.storyElements.push(
      new Story(
        "If you haven't yet spent your pebble(s) go to the upgrades tab and choose an upgrade. 1000 pebbles will get you a rock. 10000 rocks will get you a boulder.  The object is to advance as far as you can, gaining more and more power."
      )
    );
    this.storyElements.push(
      new Story(
    ...
    this.storyElements.push(
      new Story(
        'As you progress you will unlock new towers and tower abilities.  You will unlock new production resources. Completing challenges will increase your power. Completing achievements will increase your power.  Finishing tiers will gain you new equipment and new abilities and more power.  Good luck!'
      )
    );
