...
class SaveGameData {
  ...
  world: {
    ...
    dumboEnemiesToSpawn: number;
    hummingbirdEnemiesToSpawn: number;
    flyerEnemiesToSpawn: number;
    clericEnemiesToSpawn: number;
  ...
  constructor(name: string) {
    ...
    this.derivatives.push(
      new Derivative(
        ...
        this.resources.dust,
        document.getElementById('btnBuyMiddleManagement'),
        document.getElementById('btnBuyMiddleManagerDustUpgrade'),
        this.upgrades[13],
        20,
        0.0001,
        true
    ...
    this.derivatives.push(
      new Derivative(
        ...
        this.resources.metal,
        this.resources.dust,
        document.getElementById('btnBuyUpperManagement'),
        document.getElementById('btnBuyUpperManagementDustUpgrade'),
        this.upgrades[14],
        20,
        0.00001,
        true
